<h2><a href="https://leetcode.com/problems/valid-tic-tac-toe-state/?envType=problem-list-v2&envId=vydt9tpr&">794. Valid Tic-Tac-Toe State</a></h2><h3>Medium</h3><hr><p>Given a Tic-Tac-Toe board as a string array <code>board</code>, return <code>true</code> if and only if it is possible to reach this board position during the course of a valid tic-tac-toe game.</p>
