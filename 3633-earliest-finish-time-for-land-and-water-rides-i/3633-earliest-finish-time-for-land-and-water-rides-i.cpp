...
public:
    ...
    int findFinish(vector<int>& s1, vector<int>& d1, vector<int>& s2, vector<int>& d2) {
        int f1 = INT_MAX;
    ...
    int earliestFinishTime(vector<int>& landStartTime, vector<int>& landDuration, vector<int>& waterStartTime, vector<int>& waterDuration) {
        return min(findFinish(landStartTime, landDuration, waterStartTime, waterDuration), findFinish(waterStartTime, waterDuration, landStartTime, landDuration));
    }
};
