<h2><a href="https://leetcode.com/problems/minimum-cost-to-split-into-ones/description/?envType=problem-list-v2&envId=vydt9tpr">3857. Minimum Cost to Split into Ones</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code>.</p>
